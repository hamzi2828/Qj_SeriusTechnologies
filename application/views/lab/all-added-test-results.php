                                    ...
                                    foreach ( $sales as $sale ) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <?php
                                                    if ( $results and !empty ( $results ) > 0 ) {
                                                        echo '<span class="label label-success">Results Added</span><br/><br/>';
                                            ...
                                            <td>
                                                <?php
                                                    if ( !empty( $verified ) ) {
                                                        echo '<span class="label label-success">Results Verified</span><br/><br/>';
                                            ...
                                            <td>
                                                <a href="<?php
                                                    echo base_url ( '/invoices/print_lab_single_invoice_lab/?id=' . @$results -> id . '&sale-id=' . $sale -> sale_id . '&parent-id=' . $sale -> test_id . '&machine=' . $results -> machine ) ?>"
                                                   class="btn <?php
                                                       echo ( $isParent or $test -> parent_id < 1 ) ? 'green btn-xs' : 'purple btn-xs' ?> btn-block"
                                                   target="_blank">Print</a>
                                                
                                                <a href="<?php
                                                    echo base_url ( '/invoices/print_lab_single_invoice_lab/?id=' . @$results -> id . '&sale-id=' . $sale -> sale_id . '&parent-id=' . $sale -> test_id . '&logo=true' . '&machine=' . $results -> machine ) ?>"
                                                   class="btn purple btn-xs btn-block" target="_blank">L-Print</a>
                                                
                                                <a href="<?php
                                                    echo base_url ( '/invoices/test-results-report/?sale-id=' . $sale -> sale_id . '&logo=true' . '&machine=' . $results -> machine ) ?>"
                                                   class="btn dark btn-xs btn-block" target="_blank">L-Print All</a>
                                                
                                                <a href="<?php
                                                    echo base_url ( '/invoices/test-results-report/?sale-id=' . $sale -> sale_id . '&logo=false' . '&machine=' . $results -> machine ) ?>"
                                                   class="btn dark btn-xs btn-block" target="_blank">Print All</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
