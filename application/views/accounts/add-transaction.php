                ...
                <form role="form" method="post" autocomplete="off">
                    ...
                    <div class="form-body" style="overflow:auto;">
                        <div class="form-group col-lg-3">
                            ...
                            <select name="acc_head_id" class="form-control select2me" required="required" id="acc_head_id" onchange="check_account_type(this.value, 0)">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline">
                                    <input type="radio" name="transaction_type" id="debit-0" value="credit"> Debit
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="transaction_type" id="credit-0" value="debit">  Credit
                                </label>
                            </div>
                        </div>
                        <div class="form-group col-lg-3">
                        ...
                        <div class="form-group col-lg-3">
                            <label for="exampleInputEmail1">Choose Account Head</label>
                            <select name="acc_head_id_2" class="form-control select2me" required="required" id="acc_head_id" onchange="check_account_type(this.value, 1)">
                                <option value="0">Select Account Head</option>
                                <?php
                                if(count($account_heads) > 0) {
                                    foreach ($account_heads as $account_head) {
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline">
                                    <input type="radio" name="transaction_type_2" id="debit-1" value="credit"> Debit
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="transaction_type_2" id="credit-1" value="debit"> Credit
                                </label>
                            </div>
                        </div>
                        <div class="form-group col-lg-3">
