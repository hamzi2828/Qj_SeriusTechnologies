                    ...
                    <div class="form-body" style="overflow: auto">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <select name="relationship" class="form-control select2me">
                                <option value="S/O" <?php echo ( isset( $_POST[ 'relationship' ] ) && $_POST[ 'relationship' ] == 'S/O' ) ? 'selected="selected"' : '' ?>>
                                    S/O
                                </option>
                                <option value="D/O" <?php echo ( isset( $_POST[ 'relationship' ] ) && $_POST[ 'relationship' ] == 'D/O' ) ? 'selected="selected"' : '' ?>>
                                    D/O
                                </option>
                                <option value="F/O" <?php echo ( isset( $_POST[ 'relationship' ] ) && $_POST[ 'relationship' ] == 'F/O' ) ? 'selected="selected"' : '' ?>>
                                    F/O
                                </option>
                                <option value="W/O" <?php echo ( isset( $_POST[ 'relationship' ] ) && $_POST[ 'relationship' ] == 'W/O' ) ? 'selected="selected"' : '' ?>>
                                    W/O
                                </option>
                                <option value="M/O" <?php echo ( isset( $_POST[ 'relationship' ] ) && $_POST[ 'relationship' ] == 'M/O' ) ? 'selected="selected"' : '' ?>>
                                    M/O
                                </option>
                            </select>
                        </div>
