                    ...
                    if(count($sheets) > 0) {
                        ...
                        foreach ($sheets as $sheet) {
                            ...
                            <tr>
                                ...
                                <td> <?php echo convert_to_month_name ( $sheet -> salary_month ) .','. date('Y', strtotime($sheet -> date_added)) ?> </td>
                                ...
                                <td class="btn-group-xs">
                                    ...
                                    <?php endif; ?>
                                    <a type="button" class="btn purple" href="<?php echo base_url('/invoices/print-salary-sheet/'.$sheet -> salary_id) ?>">Print</a>
                                    <a type="button" class="btn purple" href="<?php echo base_url('/invoices/salary-slips?salary_slip='.$sheet -> salary_id) ?>">Print Slips</a>
                                </td>
                            </tr>
                    <?php
                        }
