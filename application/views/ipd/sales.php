		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
                    ...
                    <?php if(!$discharged) echo 'IPD Sales (Cash)'; else echo 'Discharged Patient Invoices'; ?>
				</div>
			</div>
					...
					if(count($sales) > 0) {
						...
						foreach ($sales as $sale) {
                            ...
                            <?php if ( get_user_access ( get_logged_in_user_id () ) and in_array ( 'c_print_ipd_invoice', explode ( ',', get_user_access ( get_logged_in_user_id () ) -> access ) ) ) : ?>
                                <a type="button" class="btn-block btn purple" href="<?php echo base_url ( '/invoices/ipd-invoice-customer?sale_id=' . $sale -> sale_id ) ?>">C
                                    Print</a>
                            <?php endif; ?>
