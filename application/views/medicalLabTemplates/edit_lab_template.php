                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: right;">
                                    <button type="button" class="btn btn-success btn-custom" id="addRowButton1">+</button>
                                </th>
                            </tr>
                        </thead>
                        <tbody id="tableBody1">
                            <?php if (!empty($rows[1])) : ?>
                                <?php foreach ($rows[1] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_1[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_1[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="tableBody2">
                            <?php if (!empty($rows[2])) : ?>
                                <?php foreach ($rows[2] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_2[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_2[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
                                        <td style="text-align: right;">
                                            <button type="button" class="btn btn-danger btn-custom removeRowButton">-</button>
                                        </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="tableBody3">
                            <?php if (!empty($rows[3])) : ?>
                                <?php foreach ($rows[3] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_3[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_3[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
                                        <td style="text-align: right;">
                                            <button type="button" class="btn btn-danger btn-custom removeRowButton">-</button>
                                        </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="tableBody4">
                            <?php if (!empty($rows[4])) : ?>
                                <?php foreach ($rows[4] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_4[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_4[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
                                        <td style="text-align: right;">
                                            <button type="button" class="btn btn-danger btn-custom removeRowButton">-</button>
                                        </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="tableBody5">
                            <?php if (!empty($rows[5])) : ?>
                                <?php foreach ($rows[5] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_5[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_5[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
                                        <td style="text-align: right;">
                                            <button type="button" class="btn btn-danger btn-custom removeRowButton">-</button>
                                        </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody id="tableBody6">
                            <?php if (!empty($rows[6])) : ?>
                                <?php foreach ($rows[6] as $index => $row) : ?>
                                    <tr>
                                        <td><?php echo $index + 1; ?></td>
                                        <td>
                                            <input type="text" name="row_name_6[]" class="form-control" value="<?php echo $row->row_name; ?>" placeholder="Name">
                                        </td>
                                        <td>
                                            <input type="text" name="row_value_6[]" class="form-control row-value" value="<?php echo $row->row_value_1; ?>" placeholder="Value">
                                        </td>
                                        <td style="text-align: right;">
                                            <button type="button" class="btn btn-danger btn-custom removeRowButton">-</button>
                                        </td>
...
<script>
    ...
    document.getElementById('addRowButton1').addEventListener('click', function () {
        addRow('tableBody1', 'row_name_1[]', 'row_value_1[]');
    });
