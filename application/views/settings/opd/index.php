						...
						foreach ($services as $service) {
							...
							<tr class="odd gradeX">
								...
								<td class="btn-group-xs">
									...
									<?php endif; ?>
							<?php if(get_user_access(get_logged_in_user_id()) and in_array('edit_opd_services', explode(',', get_user_access(get_logged_in_user_id()) -> access))) : ?>
									<a type="button" class="btn blue" href="<?php echo base_url('/settings/edit-service/'.$service -> id.'?settings=opd') ?>">Edit</a>
							<?php endif; ?>
                            <?php if(get_user_access(get_logged_in_user_id()) and in_array('delete_opd_services', explode(',', get_user_access(get_logged_in_user_id()) -> access))) : ?>
