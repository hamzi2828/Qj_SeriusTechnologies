    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Add Templates (Ultrasound)
                </div>
            </div>
            <div class="portlet-body form">
                ...
                <form role="form" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="action" value="do_add_template">
                    <div class="form-body" style="overflow:auto;">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control ckeditor" id="ckeditor" placeholder="Add study" name="study" rows="15"
                                      style="height: 100%"><?php echo set_value ( 'study' ) ?></textarea>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control ckeditor" placeholder="Add conclusion" name="conclusion"
                                      rows="15" style="height: 100%"><?php echo set_value ( 'conclusion' ) ?></textarea>
                        </div>
