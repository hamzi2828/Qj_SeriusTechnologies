    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Edit Template (Ultrasound)
                </div>
            </div>
                    ...
                    <div class="form-body" style="overflow:auto;">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <select name="gender" class="form-control">
                                ...
                                <option value="male" <?php echo $template -> gender == 'male' ? 'selected="selected"' : '' ?>>Male</option>
                                <option value="female" <?php echo $template -> gender == 'female' ? 'selected="selected"' : '' ?>>Female</option>
                            </select>
                        </div>
