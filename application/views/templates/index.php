    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i> Templates (Ultrasound)
                </div>
            </div>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="btn-group-xs">
                                        <a type="button" class="btn blue"
                                           href="<?php echo base_url ( '/templates/edit/?id=' . encode ( $template -> id ) ) ?>">Edit</a>
                                        <a type="button" class="btn red"
                                           href="<?php echo base_url ( '/templates/delete/?id=' . encode ( $template -> id ) ) ?>"
