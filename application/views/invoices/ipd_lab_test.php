...
<div style="text-align: right">
    <strong>Patient EMR#</strong> <?php echo $test -> patient_id ?> <br>
    <strong>Patient Name#</strong> <?php echo @get_patient($test -> patient_id) -> name ?> <br>
...
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="1">
	...
	if(!empty($test)) {
        ...
        <tr>
            ...
            <td> <?php echo get_test_by_id($test -> test_id) -> name ?> </td>
            <td> <?php echo $test -> price ?> </td>
            <td> <?php echo $test -> discount ?> </td>
            <td> <?php echo $test -> net_price ?> </td>
