...
<table width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="0">
    <tr>
        <td style="width: 100%; background: #f5f6f7; text-align: center">
            <h3> <strong> Stock Valuation Report (TP Wise) </strong> </h3>
        </td>
    </tr>
</table>
<br>
	...
	if(count($medicines) > 0) {
		...
		foreach ($medicines as $medicine) {
            ...
            <tr class="odd gradeX">
                ...
                <td><?php echo $quantity - $sold - $issued - $ipd_issuance - $expired - $return_supplier - $adjustment_qty; ?></td>
                <td><?php echo $net_value ?></td>
            </tr>
			<?php
		}
		?>
        <tr>
            <td colspan="14" class="text-right" style="text-align: right">
                <strong>Total:</strong>
            </td>
            <td>
