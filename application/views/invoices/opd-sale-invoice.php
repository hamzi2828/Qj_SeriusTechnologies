...
<table width="100%"><tr>
<td width="50%" style="color:#000; "><img src="<?php echo base_url('/assets/img/logo-new.jpeg') ?>" width="150"></td>
<td width="50%" style="text-align: right;"><span style="font-weight: bold; font-size: 14pt;"><?php echo site_name ?></span><br /><?php echo hospital_address ?><br /><span style="font-family:dejavusanscondensed;">&#9742;</span> <?php echo hospital_phone ?> <br /> <br /><span style="font-weight: bold; font-size: 25pt;"><?php echo $sale_id ?></span><br><br><strong>Patient EMR: </strong><?php echo get_patient($sales[0] -> patient_id) -> id ?><br><strong>Patient Name: </strong><?php echo get_patient($sales[0] -> patient_id) -> name ?></td>
</tr></table>
</htmlpageheader>
...
<br/>
<?php
$patient_info = get_patient($sales[0] -> patient_id);
...
<div style="text-align: right; width: 100%; display: block; text-align: right"><br>
    <strong>Receipt Date:</strong> <?php echo date_setter($sales[0] -> date_added) ?>
</div>
<br/>
...
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="1">
    ...
    if(count($sales) > 0) :
        $counter    = 1;
        $sale_info  = get_opd_sale($sales[0] -> sale_id);
    ...
    <?php endforeach; ?>
        ...
        <tr>
            ...
            <td align="center">
                <strong><?php echo $sale_info -> net; ?></strong>
            </td>
        </tr>
    <?php endif; ?>
    </tbody>
