...
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="1">
	<?php
	if(count($combined_forms) > 0) {
		$counter = 1;
		?>
        <tr class="odd gradeX has-medicines">
            <td></td>
            <td><strong>Tablets/Capsules</strong></td>
            <td colspan="14"></td>
        </tr>
        <thead>
        <tr>
        ...
        <tbody>
    <?php
		foreach ($combined_forms as $combined_form) {
			$medicines = get_medicines_by_form($combined_form -> id);
			?>
			<?php
