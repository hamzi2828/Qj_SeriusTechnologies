...
<table width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="0">
    <tr>
        <td style="width: 100%; background: #f5f6f7; text-align: center">
            <h3> <strong> Analysis Report - Sale </strong> </h3>
        </td>
    </tr>
</table>
<br>
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="1">
	...
	if ( count ( $analysis ) > 0 ) {
		...
		foreach ( $analysis as $sale ) {
			...
			$ipd_quantity = get_ipd_issued_medicine_quantity ( $sale -> medicine_id );
			$ipd_med_price = get_ipd_issued_medicine_net_price ( $sale -> medicine_id );
			$ipd_net_price = $ipd_net_price + $ipd_med_price;
			$total_sum = $sale -> net_price + $ipd_net_price;
			?>
            <tr>
                <td>
					<?php echo $counter; ?>
                ...
                <td> <?php echo $ipd_quantity > 0 ? $ipd_quantity : 0; ?> </td>
                <td> <?php echo number_format ( $sale -> net_price, 2 ) ?> </td>
                <td> <?php echo number_format ( $ipd_net_price, 2 ) ?> </td>
                <td> <?php echo number_format ( $sale -> net_price + $ipd_net_price, 2 ) ?> </td>
        ...
        <tr>
            <td colspan="5">
                <strong style="color: #ff0000">The following total is shown excluding the discount, as the discount is
                    on over sale, not single medicine.</strong>
            </td>
            <td><strong><?php echo number_format ( $total, 2 ); ?></strong></td>
            <td><strong><?php echo number_format ( $ipd_net_price, 2 ); ?></strong></td>
