...
<table width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="0">
    <tr>
        <td style="width: 100%; background: #f5f6f7; text-align: center">
            <h3> <strong> General Summary Report (Consultancy, OPD, Lab Sales) </strong> </h3>
        </td>
    </tr>
</table>
<br>
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="1">
    ...
    <tbody>
    <tr>
        <td align="center"><?php echo number_format($consultancy_total -> net, 2) ?></td>
        <td align="center"><?php echo number_format($opd_total -> net, 2) ?></td>
        <td align="center"><?php echo number_format($lab_total -> net, 2) ?></td>
        <td align="center"><?php echo number_format($lab_total -> net + $consultancy_total -> net + $opd_total -> net, 2) ?></td>
    </tr>
    </tbody>
</table>
</body>
