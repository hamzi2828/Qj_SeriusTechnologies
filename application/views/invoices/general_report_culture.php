...
<table width="100%">
	<tr>
		<td width="50%" style="color:#000; ">
			<img src="<?php echo base_url ( '/assets/img/logo-new.jpeg' ) ?>" height="80px"> <br><br><br>
		</td>
		<td width="50%" style="text-align: right;">
			<span style="font-size: 8pt">
                ...
                <strong>Receipt Date:</strong> <?php echo date ( 'd-m-Y' ) . '@' . date ( 'g:i a' ) ?> <br />
    ...
    <?php
        if ( count ( $sales ) > 0 ) {
            ...
            foreach ( $sales as $sale ) {
                $patient_id = get_patient_id_by_sale_id ( $sale -> sale_id );
