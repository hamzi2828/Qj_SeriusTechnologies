...
<table width="100%"><tr>
<td width="50%" style="color:#0000BB; "><img src="<?php echo base_url('/assets/img/logo-new.jpeg') ?>" style="height: 80px"><br><br /><br /><br />Supplier: <b><?php echo $supplier -> title ?><br><br />Return Date: <b><?php echo date_setter($return_info -> date_added) ?></b></td>
