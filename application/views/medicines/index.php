...
//                                print_data ('Quantity: ' . $quantity);
//                                print_data ('Sold: ' . $sold);
//                                print_data ('Return Supplier: ' . $return_supplier);
//                                print_data ('Issued: ' . $issued);
//                                print_data ('IPD Issuance: ' . $ipd_issuance);
//                                print_data ('Adjust Qty: ' . $adjustment_qty);
