    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Regents Consumption Report (IPD)
                </div>
				<?php if(count( $regent_consumption) > 0) : ?>
                    <a href="<?php echo base_url('/invoices/regents-consumption-invoice-ipd?'.$_SERVER['QUERY_STRING']) ?>" class="pull-right print-btn" target="_blank">Print</a>
				<?php endif ?>
            </div>
