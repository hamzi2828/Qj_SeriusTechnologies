    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i> Analysis Report - Sale
                </div>
				<?php if(count($analysis) > 0) : ?>
                    <a href="<?php echo base_url('/invoices/analysis-report-sale?'.$_SERVER['QUERY_STRING']); ?>" class="pull-right print-btn">Print</a>
				<?php endif ?>
            </div>
