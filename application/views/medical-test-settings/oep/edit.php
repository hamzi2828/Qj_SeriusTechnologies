        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form role="form" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="action" value="update_oep">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="prefix" class="form-control" id="prefix"
                                       autofocus="autofocus" value="<?php echo set_value ( 'prefix', $oep -> prefix ) ?>"
                                       required="required">
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                       value="<?php echo set_value ( 'name', $oep -> name ) ?>"
                                       required="required">
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="representative" class="form-control" id="representative"
                                       value="<?php echo set_value ( 'representative', $oep -> representative ) ?>">
                            </div>
                            
                            <div class="form-group col-lg-3">
                                <label for="contact">Contact</label>
                                <input type="text" name="contact" class="form-control" id="contact"
                                       value="<?php echo set_value ( 'contact', $oep -> contact ) ?>">
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="price">Price</label>
                                <input type="number" name="price" class="form-control" id="price" step="0.01"
                                    value="<?php echo set_value('price', $oep->price) ?>" required="required">
                            </div>

                            <div class="form-group col-lg-12 mb-0">
                                <label for="address">Address</label>
                                <textarea name="address" class="form-control" rows="5" id="address"
                                          placeholder="Member address"><?php echo set_value ( 'address', $oep -> address ) ?></textarea>
                            </div>
                        </div>
                    </div>
