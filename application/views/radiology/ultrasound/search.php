    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Search Ultrasound Report
                </div>
            </div>
                ...
                <?php
                    if ( $report and !empty( $report ) ) {
                        ...
                        <form role="form" method="post" autocomplete="off">
                            ...
                            <input type="hidden" name="action" value="do_edit_ultrasound_report">
                            ...
                            <div class="form-body" style="overflow:auto;">
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" name="sale-id" class="form-control" placeholder="Invoice ID"
                                        ...
                                        echo $report -> sale_id ?>"
                                           required="required" onchange="get_patient_by_lab_sale_id_and_test_type(this.value, 17)">
                                </div>
                                <div class="form-group col-lg-2">
